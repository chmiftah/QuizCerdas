<template>
  ...
  <div v-if="shouldShowDock" class="z-40">
    ...
    <nav class="fixed bottom-3 left-3 right-3 max-w-lg mx-auto z-40 bg-white/95 backdrop-blur-2xl border-2 border-white/90 shadow-[0_12px_40px_rgba(15,23,42,0.18)] rounded-[30px] p-1.5 flex justify-around items-center transition-all duration-300">
