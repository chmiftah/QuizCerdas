          ...
          },
          {
            ...
            "exercises": [
              ...
              },
              {
                ...
                "options": ["3 Bintang", "5 Bintang", "8 Bintang", "6 Bintang"],
          ...
          "exercises": [
            {
              ...
              "options": ["11, 13, 12", "14, 15, 16", "18, 20, 19", "15, 17, 16"],
...
with open('data/course_counting.json', 'w', encoding='utf-8') as f:
    json.dump(course_data, f, ensure_ascii=False, indent=2)

print('SUCCESS_REGENERATED_COURSE_JSON')
